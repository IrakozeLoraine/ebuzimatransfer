...
interface Props {
  monitoring: TransportMonitoring | null | undefined;
}
...
/** Read-only display of the driver's voice-recorded Patient Monitoring Transfer
 *  Form — shown to both clinics and admins on the referral detail page. */
export const TransportMonitoringCard = ({ monitoring }: Props) => {
        ...
        <CardTitle className="flex items-center gap-2 text-sm">
          ...
          {monitoring.recorded_at && (
            <span className="ml-auto text-xs font-normal text-muted-foreground">
              Recorded {formatDateTime(monitoring.recorded_at)}
            </span>
          )}
        </CardTitle>
      </CardHeader>
